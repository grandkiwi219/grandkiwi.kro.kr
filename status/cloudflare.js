...
cf.summary({
  success : function(data) {
         ...
         document.getElementById('cloudflare').innerHTML += '<a href="javascript:void(0)" id="a_show" onclick="if (div_hide.style.display == "none") { div_hide.style.display=""; a_show.innerText = "[ 접기 ]" } else { div_hide.style.display="none"; a_show.innerText = "[ 펼치기 ]" }">[ 펼치기 ]</a><div id=""div_hide" style="display:none;">';
