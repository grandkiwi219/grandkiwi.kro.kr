...
/*if ( confirm("IE환경에서는 사이트 이용이 원활하지 않을 수 있습니다\n계속 하시겠습니까?") ) {
    ...
    const menual = "IE 환경에서는 사이트 이용이 원활하지 않을 수 있습니다<br style='visible:hidden;' />Chrome이나 FireFox와 같은 다른 브라우저 이용을 하시는걸 권장합니다"
...
var notice = "Merry Christmas 🎄!<br style='visible:hidden;' />좋은 하루 되시길 바랍니다!"
